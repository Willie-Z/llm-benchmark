...
# -*- coding: utf-8 -*-
"""
星流 LLM 验收工具 · 本地代理 + 静态服务
- GET /  /index.html /_data.js  →  返回静态文件（同源，浏览器无跨域问题）
...
用法： python serve.py   （然后浏览器开 http://127.0.0.1:8000/）
"""
...
if __name__ == "__main__":
    ...
    print("星流验收工具本地代理+静态服务已启动: http://127.0.0.1:%d/  (Ctrl+C 退出)" % PORT)
    try:
        srv.serve_forever()
